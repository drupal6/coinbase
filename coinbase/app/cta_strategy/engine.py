...
from coinbase.event import Event, EventEngine
from coinbase.trader.engine import BaseEngine, MainEngine
...
from coinbase.trader.event import (
    EVENT_TICK,
    EVENT_BAR,
    EVENT_ORDER,
    EVENT_TRADE,
...
from coinbase.trader.utility import load_json, save_json, extract_vt_symbol, round_to
from coinbase.trader.database import database_manager
from coinbase.trader.converter import OffsetConverter
...
class CtaEngine(BaseEngine):
    ...
    def register_event(self):
        ...
        self.event_engine.register(EVENT_BAR, self.process_kline_event)
    ...
    def load_strategy_class(self):
        ...
        self.load_strategy_class_from_folder(
            path1, "coinbase.app.cta_strategy.strategies")
