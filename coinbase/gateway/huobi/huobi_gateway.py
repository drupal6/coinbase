...
class HuobiRestApi(RestClient):
    ...
    def query_order(self, req: QueryRequest):
        self.add_request(
            method="GET",
            path="/v1/order/orders/%s" % req.orderid,
...
class HuobiDataWebsocketApi(HuobiWebsocketApiBase):
    ...
    def on_market_kline(self, data: dict) -> None:
        symbol = data["ch"].split(".")[1]
